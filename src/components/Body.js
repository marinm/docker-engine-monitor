...
function Body() {
    ...
    return (
        <div className="Body">
            ...
            <LiveTable title="containerd" ms={5 * 1000} check={
                function(callback) {
                    docker.version(result => 
                        callback([
            ...
            <LiveTable title="runc" ms={5 * 1000} check={
                function(callback) {
                    docker.version(result => 
                        callback([
            ...
            <LiveTable title="docker-init" ms={5 * 1000} check={
                function(callback) {
                    docker.version(result => 
                        callback([
            ...
            <LiveTable title="Info" ms={5 * 1000} check={
                function(callback) {
                    docker.info(result => 
                        callback([
                            [ 'Driver Status'          , '►' ],
